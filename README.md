...
To work with the cluster in development, follow the instructions [here](docs/run-local.md). Once all of the tasks have been completed the URL to access the local cluster is [https://host.docker.internal]https://host.docker.internal/
