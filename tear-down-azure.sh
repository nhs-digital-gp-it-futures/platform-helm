...
az storage blob list -c $branchName --connection-string "$azureStorageConnectionString"

echo `az storage blob delete -c $branchNamespace --connection-string "$azureStorageConnectionString"`
echo `az storage blob delete -c $prNamespace --connection-string "$azureStorageConnectionString"`
